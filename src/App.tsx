      ...
      >
        ...
        {qrCode && (
          <div className="mb-8">
            ...
            <div className="bg-white p-4 border border-slate-200 dark:border-slate-800 rounded-2xl inline-block shadow-sm">
              <img src={qrCode} alt="Verification QR" className="w-40 h-40" />
            </div>
